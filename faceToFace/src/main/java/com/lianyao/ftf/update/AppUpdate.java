...
import com.lianyao.ftf.update.AppUpdateService.OnCliListener;
...
public interface AppUpdate {
	...
	void onFoundLatestV(Version targetVersion);

	/**
	 * 
	 * @param isShow
	 */
	void showPromptWhenCurrentIsLatest(boolean isShow);

	void setOnCliListener(OnCliListener cliListener);
}
