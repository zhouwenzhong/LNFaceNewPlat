 ...
 * It allows to unpack content values from registration/activation status of a
 * {@link SipProfile}.
 */
public class SipProfileState implements Parcelable, Serializable {
	...
	/**
	 * Wizard key. <br/>
	 * Wizard identifier associated to the account. This is a shortcut to not
	 * have to query {@link SipProfile} database
	 * 
	 * @see String
	 */
	...
	public static final String[] FULL_PROJECTION = new String[] { ACCOUNT_ID,
			PJSUA_ID, WIZARD, ACTIVE, STATUS_CODE, STATUS_TEXT, EXPIRES,
			DISPLAY_NAME, PRIORITY, REG_URI };
	...
	/**
	 * Get the identifier identifier of the account that this state is linked
	 * to.
	 * 
