...
package com.lianyao.ftf.sdk.view;
...
/**
 * Simple container that confines the children to a subrectangle specified as
 * percentage values of the container size. The children are centered
 * horizontally and vertically inside the confined space.
 */
public class PercentFrameLayout extends ViewGroup {
	...
	public void setPosition(int xPercent, int yPercent, int widthPercent,
			int heightPercent) {
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		final int childWidthMeasureSpec = MeasureSpec.makeMeasureSpec(width
				* widthPercent / 100, MeasureSpec.AT_MOST);
		final int childHeightMeasureSpec = MeasureSpec.makeMeasureSpec(height
				* heightPercent / 100, MeasureSpec.AT_MOST);
